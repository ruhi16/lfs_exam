    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div
            ...
            <div class="relative mb-4">
                <?php if($teacher && $teacher->img_ref): ?>
            ...
            <div class="text-center text-white">
                ...
                <span class="mt-2 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium 
                    <?php echo e($user->status == 'active' ? 'bg-green-400/30 text-green-100' : 'bg-red-400/30 text-red-100'); ?>">
                    <span class="w-2 h-2 rounded-full mr-1 
                        <?php echo e($user->status == 'active' ? 'bg-green-300' : 'bg-red-300'); ?>"></span>
        ...
        <div class="md:w-3/4 p-6">
            <?php if($teacher): ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900"><?php echo e($teacher->desig ?: '-'); ?>

                                , <?php echo e($teacher->hqual ?: '-'); ?>

                                , <?php echo e($teacher->train_qual ?: '-'); ?>

                                , <?php echo e($teacher->extra_qual ?: '-'); ?>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900"><?php echo e($teacher->mobno ?: '-'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900"><?php echo e($teacher->school->name ?? '-'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900"><?php echo e($teacher->session->name ?? '-'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start sm:col-span-2">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">
                                <?php echo e($teacher->subject->name ?? ($teacher->main_subject_id ? 'Subject ID: ' . $teacher->main_subject_id : '-')); ?>
                ...
                <?php if($teacher->hqual || $teacher->train_qual): ?>
