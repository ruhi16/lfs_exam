                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            <h3 class="text-2xl leading-6 font-bold text-gray-900 mb-4" id="modal-headline">
                                <?php echo e($exam03PartId ? 'Edit Exam Part' : 'Add New Exam Part'); ?>
                            ...
                            <div class="mt-2">
                                <form>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="mb-4">
                                            <label for="name" class="block text-sm font-medium text-gray-700">Exam Part Name *</label>
                                            <input type="text" 
                                                   wire:model="name" 
                                                   id="name" 
...
unset($__errorArgs, $__bag); ?>"
                                                   placeholder="Enter exam part name">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button wire:click.prevent="store()" 
                        ...
                        <?php echo e($exam03PartId ? 'Update' : 'Save'); ?>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Exam Part Management</h2>
            ...
            <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 w-full md:w-auto">
                ...
                <div class="flex space-x-2">
                    <select wire:model="perPage" 
                        ...
                        <option value="<?php echo e($exam03Parts->total()); ?>">Show All</option>
                    </select>
        ...
        <div class="overflow-x-auto bg-white border border-gray-200 rounded-lg shadow-sm">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $exam03Parts ?? collect([]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam03Part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($exam03Part->id); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($exam03Part->name); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($exam03Part->order_index ?? '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($exam03Part->session ? $exam03Part->session->name : '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    <?php echo e($exam03Part->is_optional ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800'); ?>">
                                    <?php echo e($exam03Part->is_optional ? 'Yes' : 'No'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    <?php echo e($exam03Part->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                    <?php echo e($exam03Part->is_active ? 'Active' : 'Inactive'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button wire:click="edit(<?php echo e($exam03Part->id); ?>)" 
                                        class="text-indigo-600 hover:text-indigo-900 mr-3">
                                    Edit
                                </button>
                                <button wire:click="delete(<?php echo e($exam03Part->id); ?>)" 
                                        onclick="confirm('Are you sure you want to delete this exam part?') || event.stopImmediatePropagation()"
        ...
        <div class="mt-6 flex flex-col sm:flex-row items-center justify-between">
            <div class="mb-4 sm:mb-0">
                Showing <?php echo e($exam03Parts->firstItem()); ?> to <?php echo e($exam03Parts->lastItem()); ?> of <?php echo e($exam03Parts->total()); ?> results
            </div>
            <div>
                <?php echo e($exam03Parts->links()); ?>

            </div>
        </div>
    </div>
</div><?php /**PATH D:\LaravelProject\LFS_Exam\resources\views/livewire/exam03-exam-part-comp.blade.php ENDPATH**/ ?>