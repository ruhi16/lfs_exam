...
<body class="font-sans antialiased scroll-smooth">
                ...
                <div class="hidden md:flex items-center space-x-8 ">
                    ...
                    <?php if(Route::has('login')): ?>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <a wire:navigate href="<?php echo e(url('/dashboard')); ?>"
                                    class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard: <?php echo e(auth()->user()->id); ?></a>
                            <?php else: ?>
    ...
    <main>
        ...
        <section id="home">
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('wcui.hero-section')->html();
} elseif ($_instance->childHasBeenRendered('SGuPE4E')) {
    $componentId = $_instance->getRenderedChildComponentId('SGuPE4E');
    $componentTag = $_instance->getRenderedChildComponentTagName('SGuPE4E');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SGuPE4E');
} else {
    $response = \Livewire\Livewire::mount('wcui.hero-section');
    $html = $response->html();
    $_instance->logRenderedChild('SGuPE4E', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
        ...
        <section id="about">
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('wcui.about-section')->html();
} elseif ($_instance->childHasBeenRendered('SKRJrAW')) {
    $componentId = $_instance->getRenderedChildComponentId('SKRJrAW');
    $componentTag = $_instance->getRenderedChildComponentTagName('SKRJrAW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SKRJrAW');
} else {
    $response = \Livewire\Livewire::mount('wcui.about-section');
    $html = $response->html();
    $_instance->logRenderedChild('SKRJrAW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
        ...
        <section id="programs">
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('wcui.programs')->html();
} elseif ($_instance->childHasBeenRendered('0Gz1thb')) {
    $componentId = $_instance->getRenderedChildComponentId('0Gz1thb');
    $componentTag = $_instance->getRenderedChildComponentTagName('0Gz1thb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0Gz1thb');
} else {
    $response = \Livewire\Livewire::mount('wcui.programs');
    $html = $response->html();
    $_instance->logRenderedChild('0Gz1thb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
        ...
        <section id="testimonials">
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('wcui.testimonials')->html();
} elseif ($_instance->childHasBeenRendered('61mCSvb')) {
    $componentId = $_instance->getRenderedChildComponentId('61mCSvb');
    $componentTag = $_instance->getRenderedChildComponentTagName('61mCSvb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('61mCSvb');
} else {
    $response = \Livewire\Livewire::mount('wcui.testimonials');
    $html = $response->html();
    $_instance->logRenderedChild('61mCSvb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
        ...
        <section id="info">
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('wcui.school-info')->html();
} elseif ($_instance->childHasBeenRendered('EGYFTHR')) {
    $componentId = $_instance->getRenderedChildComponentId('EGYFTHR');
    $componentTag = $_instance->getRenderedChildComponentTagName('EGYFTHR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EGYFTHR');
} else {
    $response = \Livewire\Livewire::mount('wcui.school-info');
    $html = $response->html();
    $_instance->logRenderedChild('EGYFTHR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
        ...
        <section id="contact">
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('wcui.contact-form')->html();
} elseif ($_instance->childHasBeenRendered('cRmjonK')) {
    $componentId = $_instance->getRenderedChildComponentId('cRmjonK');
    $componentTag = $_instance->getRenderedChildComponentTagName('cRmjonK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cRmjonK');
} else {
    $response = \Livewire\Livewire::mount('wcui.contact-form');
    $html = $response->html();
    $_instance->logRenderedChild('cRmjonK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="border-t border-gray-700 mt-12 pt-8 text-center">
                <p class="text-gray-400">
                    © <?php echo e(date('Y')); ?> Little Flowers Nursery School. All rights reserved. 
...
</html><?php /**PATH /home/bkoq0ic0h8xi/public_html/littleflowerschool.co.in/resources/views/welcome.blade.php ENDPATH**/ ?>