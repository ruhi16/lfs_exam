    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300 text-center">
                <div class="text-5xl mb-4"><?php echo e($feature['icon']); ?></div>
                <h3 class="text-xl font-bold text-gray-800 mb-3"><?php echo e($feature['title']); ?></h3>
...
</div><?php /**PATH /home/bkoq0ic0h8xi/public_html/littleflowerschool.co.in/resources/views/livewire/wcui/about-section.blade.php ENDPATH**/ ?>