<div class="flex-1 p-6 overflow-y-auto max-w-6xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $examParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $examPart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="flex items-center">
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($examPart->name); ?></div>
                                    <?php if($examPart->is_finalized): ?>
                        ...
                        <td class="px-4 py-3">
                            <div class="text-sm text-gray-900"><?php echo e($examPart->description ?: '-'); ?></div>
                            <?php if($examPart->remarks): ?>
                            <div class="text-xs text-gray-500"><?php echo e(Str::limit($examPart->remarks, 50)); ?></div>
                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($examPart->order_index ?: '-'); ?>
                            ...
                            <div class="flex items-center space-x-2">
                                <span
                                    class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium 
                                                                            <?php if($examPart->is_active): ?> bg-green-100 text-green-800 <?php else: ?> bg-red-100 text-red-800 <?php endif; ?>">
                                    <?php echo e($examPart->is_active ? 'Active' : 'Inactive'); ?>

                                </span>
                                <?php if($examPart->status): ?>
                                <span class="text-xs text-gray-500"><?php echo e($examPart->status); ?></span>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($examPart->created_at); ?>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                <?php if($examPart->is_finalized): ?>
                                <button wire:click="unfinalizeData(<?php echo e($examPart->id); ?>)"
                                ...
                                <?php else: ?>
                                <button wire:click="confirmFinalize(<?php echo e($examPart->id); ?>)"
                                    class="bg-green-500 hover:bg-green-700 text-white px-2 py-1 rounded text-xs">
                                    🔒 Finalize
                                </button>
                                <button wire:click="toggleStatus(<?php echo e($examPart->id); ?>)"
                                    class="text-indigo-600 hover:text-indigo-900 text-xs">
                                    <?php echo e($examPart->is_active ? 'Deactivate' : 'Activate'); ?>

                                </button>
                                <button wire:click="edit(<?php echo e($examPart->id); ?>)"
                                    class="text-indigo-600 hover:text-indigo-900 text-xs">
                                    Edit
                                </button>
                                <button wire:click="confirmDelete(<?php echo e($examPart->id); ?>)"
        ...
        <!-- Pagination -->
        <?php if($examParts->hasPages()): ?>
        <div class="px-4 py-3 bg-gray-50 border-t border-gray-200">
            <?php echo e($examParts->links()); ?>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="mb-4">
                            <h3 class="text-lg font-medium text-gray-900" id="modal-title">
                                <?php echo e($editingId ? 'Edit Exam Part' : 'Add New Exam Part'); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /home/bkoq0ic0h8xi/public_html/littleflowerschool.co.in/resources/views/livewire/exam-part-comp.blade.php ENDPATH**/ ?>