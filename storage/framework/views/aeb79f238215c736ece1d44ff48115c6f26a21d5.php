...
} elseif ($_instance->childHasBeenRendered('SXRcnFa')) {
    $componentId = $_instance->getRenderedChildComponentId('SXRcnFa');
    $componentTag = $_instance->getRenderedChildComponentTagName('SXRcnFa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SXRcnFa');
} else {
    $response = \Livewire\Livewire::mount('wcui.hero-section');
    $html = $response->html();
    $_instance->logRenderedChild('SXRcnFa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
...
} elseif ($_instance->childHasBeenRendered('hM287ho')) {
    $componentId = $_instance->getRenderedChildComponentId('hM287ho');
    $componentTag = $_instance->getRenderedChildComponentTagName('hM287ho');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hM287ho');
} else {
    $response = \Livewire\Livewire::mount('wcui.about-section');
    $html = $response->html();
    $_instance->logRenderedChild('hM287ho', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
...
} elseif ($_instance->childHasBeenRendered('3dtk1am')) {
    $componentId = $_instance->getRenderedChildComponentId('3dtk1am');
    $componentTag = $_instance->getRenderedChildComponentTagName('3dtk1am');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3dtk1am');
} else {
    $response = \Livewire\Livewire::mount('wcui.programs');
    $html = $response->html();
    $_instance->logRenderedChild('3dtk1am', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
...
} elseif ($_instance->childHasBeenRendered('NojiGIv')) {
    $componentId = $_instance->getRenderedChildComponentId('NojiGIv');
    $componentTag = $_instance->getRenderedChildComponentTagName('NojiGIv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NojiGIv');
} else {
    $response = \Livewire\Livewire::mount('wcui.testimonials');
    $html = $response->html();
    $_instance->logRenderedChild('NojiGIv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
...
} elseif ($_instance->childHasBeenRendered('4ALZzBN')) {
    $componentId = $_instance->getRenderedChildComponentId('4ALZzBN');
    $componentTag = $_instance->getRenderedChildComponentTagName('4ALZzBN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4ALZzBN');
} else {
    $response = \Livewire\Livewire::mount('wcui.school-info');
    $html = $response->html();
    $_instance->logRenderedChild('4ALZzBN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
...
} elseif ($_instance->childHasBeenRendered('TjWSN1h')) {
    $componentId = $_instance->getRenderedChildComponentId('TjWSN1h');
    $componentTag = $_instance->getRenderedChildComponentTagName('TjWSN1h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TjWSN1h');
} else {
    $response = \Livewire\Livewire::mount('wcui.contact-form');
    $html = $response->html();
    $_instance->logRenderedChild('TjWSN1h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </section>
...
</html><?php /**PATH D:\LaravelProject\LFS_Exam\resources\views/welcome.blade.php ENDPATH**/ ?>