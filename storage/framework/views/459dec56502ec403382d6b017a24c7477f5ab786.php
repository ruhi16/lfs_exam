    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center">
            ...
            <label for="toggle-edit" class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" id="toggle-edit" class="sr-only peer" wire:click="toggleEditMode" <?php echo e($isEditMode ? 'checked' : ''); ?>>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 sticky left-0 bg-white z-10 border-r">
                            ...
                            <span class="text-xs text-gray-500 block">
                                <?php echo e($subject->subjectType ? $subject->subjectType->name : 'No Type'); ?>
                        ...
                        <?php $__currentLoopData = $myclasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $myclass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center border-l">
                                <input type="checkbox" 
                                    ...
                                    wire:click="updateMapping(<?php echo e($subject->id); ?>, <?php echo e($myclass->id); ?>, $event.target.checked)"
                                >
                            </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tr>
...
<?php /**PATH D:\LaravelProject\LFS_Exam\resources\views/livewire/basic11-class-subject-comp.blade.php ENDPATH**/ ?>