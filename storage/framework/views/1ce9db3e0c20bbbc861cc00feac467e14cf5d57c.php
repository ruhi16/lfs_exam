...
<div class="py-20 bg-gradient-to-r from-blue-600 to-purple-700 text-white">
    <div class="container mx-auto px-6">
        ...
        <div class="max-w-4xl mx-auto relative">
            ...
            <div class="<?php echo e($currentTestimonial === $index ? 'block' : 'hidden'); ?>">
                <div class="bg-white/10 backdrop-blur rounded-2xl p-8 md:p-12 text-center">
                    ...
                    <div class="border-t border-white/20 pt-6">
                        <div class="font-semibold text-lg"><?php echo e($testimonial['name']); ?></div>
                        <div class="text-blue-200">Parent of <?php echo e($testimonial['child']); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center space-x-3 mt-8">
                <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button wire:click="currentTestimonial = <?php echo e($index); ?>" 
                        class="w-3 h-3 rounded-full transition-all duration-300 <?php echo e($currentTestimonial === $index ? 'bg-white' : 'bg-white/40 hover:bg-white/60'); ?>">
                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
</div><?php /**PATH /home/bkoq0ic0h8xi/public_html/littleflowerschool.co.in/resources/views/livewire/wcui/testimonials.blade.php ENDPATH**/ ?>