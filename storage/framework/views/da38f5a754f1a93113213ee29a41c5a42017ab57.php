        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <div class="text-gray-600"><?php echo e($schoolData['address']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="text-gray-600"><?php echo e($schoolData['phone']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="text-gray-600"><?php echo e($schoolData['email']); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $schoolData['timings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between items-center">
                            <span class="font-semibold text-gray-700"><?php echo e($day); ?></span>
                            <span class="text-gray-600"><?php echo e($time); ?></span>
                        </div>
            ...
            <div>
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <?php $__currentLoopData = $schoolData['facilities']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center p-3 bg-white rounded-lg shadow-sm">
                            <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                            </svg>
                            <span class="text-sm text-gray-700"><?php echo e($facility); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="mt-8 grid grid-cols-2 gap-6">
                    <div class="bg-yellow-50 rounded-xl p-6 text-center">
                        <div class="text-3xl font-bold text-yellow-600 mb-2"><?php echo e($schoolData['students']); ?></div>
                        <div class="text-gray-600">Happy Students</div>
                    </div>
                    <div class="bg-blue-50 rounded-xl p-6 text-center">
                        <div class="text-3xl font-bold text-blue-600 mb-2"><?php echo e($schoolData['teachers']); ?></div>
...
</div><?php /**PATH /home/bkoq0ic0h8xi/public_html/littleflowerschool.co.in/resources/views/livewire/wcui/school-info.blade.php ENDPATH**/ ?>