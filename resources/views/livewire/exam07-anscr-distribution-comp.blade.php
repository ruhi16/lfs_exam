<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        @if(isset($classes[$activeTab]))
            ...
            @if($classSections->count() > 0 && $summativeSubjects->count() > 0)
            ...
            @elseif($summativeSubjects->count() == 0)
                <div class="text-center py-12">
                    <div class="text-gray-400 mb-4">
                        <svg class="mx-auto h-12 w-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-1">No Summative Subjects Found</h3>
                    <p class="text-gray-500">No Summative subjects are assigned to this class.</p>
                </div>
            @endif
        @else
            <div class="text-center py-12">
