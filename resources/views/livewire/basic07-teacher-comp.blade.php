                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" 
                                                   wire:model="nickName" 
                                                   id="nickName" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('nickName') border-red-500 @enderror"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" 
                                                   wire:model="mobno" 
                                                   id="mobno" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('mobno') border-red-500 @enderror"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" 
                                                   wire:model="desig" 
                                                   id="desig" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('desig') border-red-500 @enderror"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" 
                                                   wire:model="hqual" 
                                                   id="hqual" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('hqual') border-red-500 @enderror"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="train_qual" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('train_qual') border-red-500 @enderror"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="extra_qual" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('extra_qual') border-red-500 @enderror"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select wire:model="main_subject_id" 
                                                    id="main_subject_id" 
                                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md p-2 border @error('main_subject_id') border-red-500 @enderror">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea 
                                                   ...
                                                   id="notes" 
                                                   rows="2"
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('notes') border-red-500 @enderror"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" 
                                                   wire:model="img_ref" 
                                                   id="img_ref" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('img_ref') border-red-500 @enderror"
                                                   placeholder="Enter image reference">
                                            @error('img_ref') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" 
                                                   wire:model="remark" 
                                                   id="remark" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('remark') border-red-500 @enderror"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   id="prev_session_pk" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('prev_session_pk') border-red-500 @enderror"
                                                   placeholder="Enter previous session PK">
                                            @error('prev_session_pk') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                        </div>
            ...
            <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 w-full md:w-auto">
                ...
                <div class="flex space-x-2">
                    <select wire:model="perPage" 
                        ...
                        <option value="{{ $teachers->total() }}">Show All</option>
                    </select>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($teachers ?? collect([]) as $teacher)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $teacher->nickName ?? '-' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $teacher->mobno ?? '-' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $teacher->desig ?? '-' }}</td>
