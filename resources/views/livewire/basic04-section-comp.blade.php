                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($sections ?? collect([]) as $section)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $section->code ?? '-' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $section->order_index ?? '-' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $section->school ? $section->school->name : '-' }}</td>
