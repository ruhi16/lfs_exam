<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        @if($students->count() > 0 && $examClassSubjects->count() > 0)
            <div class="p-6">
                            ...
                            @foreach($students as $student)
                                @foreach($examParts as $examPart)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        @foreach($examClassSubjects as $examClassSubject)
                                            @php
                                                $cellKey = $myclassSectionId . '_' . $student->id . '_' . $examClassSubject->id . '_' . $examPart->exam_detail_id;
                                            @endphp
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500">No students or exam subjects are available for this selection.</p>
            </div>
        @endif
    </div>
    ...
    <div class="mt-6 text-sm text-gray-500">
        Showing exam marks entries for {{ $students->count() ?? 0 }} students
    </div>
</div>