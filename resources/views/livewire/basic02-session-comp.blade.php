                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="date" 
                                                   wire:model="stdate" 
                                                   id="stdate" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('stdate') border-red-500 @enderror">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="date" 
                                                   wire:model="entdate" 
                                                   id="entdate" 
                                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border @error('entdate') border-red-500 @enderror">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select wire:model="prev_session_id" 
                                                    id="prev_session_id" 
                                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md p-2 border @error('prev_session_id') border-red-500 @enderror">
                                                <option value="">-- Select Previous Session --</option>
                                                @foreach($allSessions as $session)
                                                    @if($session->id != $sessionId) <!-- Don't show current session as option -->
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select wire:model="next_session_id" 
                                                    id="next_session_id" 
                                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md p-2 border @error('next_session_id') border-red-500 @enderror">
                                            ...
                                            @error('next_session_id') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($sessions ?? collect([]) as $session)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $session->code ?? '-' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $session->stdate ? \Carbon\Carbon::parse($session->stdate)->format('d M Y') : '-' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $session->entdate ? \Carbon\Carbon::parse($session->entdate)->format('d M Y') : '-' }}</td>
