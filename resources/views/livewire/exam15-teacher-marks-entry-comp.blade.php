    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        @if($showIndividualView)
            <div class="mt-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <livewire:exam10-exam-marks-entry-indv2-comp :exam_class_subject_id="$individualExamClassSubjectId"
                    :exam_detail_id="$individualExamDetailId" :myclass_section_id="$individualMyclassSectionId"
                    :myclass_subject_id="$individualMyclassSubjectId" :key="'individual-' . $individualExamClassSubjectId" />
            </div>
        @endif
    </div>
</div>